...
export var TweenLite = (function (window) {
  ...
  var _checkTimeout = function () {
    if (
      ...
      ((_doc || {}).visibilityState !== "hidden" || !_ticker.lagSmoothing())
    ) {
  ...
  p.isActive = function () {
    ...
    return (
      ...
      (!this._gc &&
        ...
        rawTime < startTime + this.totalDuration() / this._timeScale - _tinyNum)
    );
  };
  ...
  p.add = p.insert = function (child, position, align, stagger) {
    ...
    if (child._paused)
      if (this !== child._timeline) {
        ...
        child._pauseTime =
          this.rawTime() - (child._timeline.rawTime() - child._pauseTime);
      }
    if (child.timeline) {
