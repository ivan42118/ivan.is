  ...
  _calculateControlPoints = function (a, curviness, quad, basic, correlate) {
    ...
    for (i = 0; i < l; i++) {
      ...
      if (correlate) {
        ...
        m1 =
          p2 - (p2 - p1) * (basic ? curviness * 0.5 : r1 !== 0 ? tl / r1 : 0);
        m2 =
          p2 + (p3 - p2) * (basic ? curviness * 0.5 : r2 !== 0 ? tl / r2 : 0);
    ...
    while (--i > -1) {
      ...
      for (j = 0; j < l; j++) {
        a =
          prepend == null
            ? values[j][p]
            : typeof (tmp = values[j][p]) === "string" && tmp.charAt(1) === "="
    ...
    set: function (v) {
      ...
      if (!this._timeRes) {
        ...
        t =
          v === 1
            ? 1
            : (i + (v1 - this._s1) / (this._s2 - this._s1)) * this._prec || 0;
      }
      inv = 1 - t;
