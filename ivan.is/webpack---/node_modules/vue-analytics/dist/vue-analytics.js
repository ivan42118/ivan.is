    ...
    function (e, n, t) {
        ...
        !(function e(n, t) {
          return (
            Object.keys(t).forEach(function (r) {
              var o = n[r] && Object.prototype.toString.call(n[r]);
      ...
      function d(e, n) {
        return new Promise(function (t, r) {
          ...
          if (((i.async = !0), (i.src = e), (i.charset = "utf-8"), n)) {
            var c = document.createElement("link");
            (c.href = n), (c.rel = "preconnect"), o.appendChild(c);
          }
          o.appendChild(i), (i.onload = t), (i.onerror = r);
        });
      }
      function y(e) {
      ...
      var m,
        v = function (e) {
          ...
          if ("function" == typeof e) {
            var n = e();
            return n.then ? n : Promise.resolve(n);
          }
                ...
                ? (h.push(o),
                  m ||
                    (m = setInterval(function () {
                      h.length
                        ? h.splice(0, l.batch.amount).forEach(function (e) {
                            var n;
                            (n = window).ga.apply(n, [e.m].concat(g(e.a)));
                          })
                        : (clearInterval(m), (m = null));
                    }, l.batch.delay)))
                : (r = window).ga.apply(r, [b(e, n)].concat(t))
              : l.untracked.push(o);
          });
      }
      function O(e) {
      ...
      function j() {
        for (var e = arguments.length, n = new Array(e), t = 0; t < e; t++)
          n[t] = arguments[t];
        "object" !== O(n[0]) || n[0].constructor !== Object
          ? w("set", n[0], n[1])
          : w("set", n[0]);
      }
      function P(e, n) {
                ...
                var t = y(n),
                  ...
                  o =
                    e.length > 1
                      ...
                      : l.fields;
                window.ga("create", n.id || n, "auto", o);
              }),
              l.beforeFirstHit();
            var n = l.ecommerce;
            if (n.enabled) {
              var t = n.enhanced ? "ec" : "ecommerce";
              n.options ? w("require", t, n.options) : w("require", t);
            }
            l.linkers.length > 0 &&
              (w("require", "linker"), w("linker:autoLink", l.linkers)),
              l.debug.sendHitTask || j("sendHitTask", null);
          }
        } else p("Google Analytics has probably been blocked.");
      }
      var E = function () {
        2 != arguments.length
          ? w("require", arguments.length <= 0 ? void 0 : arguments[0])
          : w(
              "require",
      ...
      var x = function () {
        ...
        l.set.forEach(function (e) {
          ...
          (e = ["ec", "ecommerce"]),
          l.require.forEach(function (n) {
            if (-1 !== e.indexOf(n) || -1 !== e.indexOf(n.name))
              throw new Error(
      ...
      function T() {
        for (var e = arguments.length, n = new Array(e), t = 0; t < e; t++)
          n[t] = arguments[t];
        var r = n[0];
        if (1 === n.length && "string" == typeof r)
          return w("send", "screenview", { screenName: r });
        w.apply(void 0, ["send", "screenview"].concat(n));
      }
      function D(e) {
        return (D =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
      ...
      function q() {
        ...
        var r;
        (n.length && !n[0]) ||
          (n.length && n[0].currentRoute && (r = n[0].currentRoute),
          n.length &&
            (function (e) {
          ...
          r
            ? R(r)
            : (j("page", "object" === D(n[0]) ? n[0].page : n[0]),
              w.apply(void 0, ["send", "pageview"].concat(n))));
      }
      function R(e) {
        if (
          ![(n = e).name, n.path].filter(Boolean).find(function (e) {
        ...
        _ = function () {
          if ("undefined" != typeof document && "undefined" != typeof window) {
            if (l.id) {
              var e,
                n,
                t = [v(l.id), v(l.disabled)];
              if (
                ((e = l.checkDuplicatedScript),
                (n = l.disableScriptLoader),
                [
                ...
                .then(function (e) {
                  ...
                  u({ id: e[0], disabled: e[1] }),
                    ...
                    l.untracked.forEach(function (e) {
                      w.apply(void 0, [e.m].concat(I(e.a)));
                    }),
                    (n = l.router),
                    (t = l.autoTracking),
                    (r = l.$vue),
                    t.page &&
                      ...
                      n.onReady(function () {
                        t.pageviewOnLoad &&
                          n.history.ready &&
                          R(n.currentRoute),
                          n.afterEach(function (e, o) {
                            var i = t.skipSamePath,
                              c = t.shouldRouterUpdate;
                            (i && e.path === o.path) ||
      ...
      var B = function (e) {
          ...
          w("send", "exception", { exDescription: e, exFatal: n });
        },
        H = function (e) {
          if (l.autoTracking.exception) {
            ...
            e.config.errorHandler = function (e, t, r) {
              B(e.message),
                ...
                "function" == typeof n && n.call(void 0, e, t, r);
            };
          }
        },
        F = B;
      ...
      var $ = function (e) {
        ...
        N = {
          event: function () {
            for (var e = arguments.length, n = new Array(e), t = 0; t < e; t++)
              n[t] = arguments[t];
            w.apply(void 0, ["send", "event"].concat(n));
          },
          exception: F,
          page: q,
          query: w,
          ...
          social: function () {
            for (var e = arguments.length, n = new Array(e), t = 0; t < e; t++)
              n[t] = arguments[t];
            w.apply(void 0, ["send", "social"].concat(n));
          },
          time: function () {
            for (var e = arguments.length, n = new Array(e), t = 0; t < e; t++)
              n[t] = arguments[t];
            w.apply(void 0, ["send", "timing"].concat(n));
          },
          screenview: T,
          ecommerce: C,
          disable: function () {
        ...
        Q = {
          inserted: function (e, n, t) {
            var r = Object.keys(n.modifiers);
            0 === r.length && r.push("click"),
              r.forEach(function (r) {
                e.addEventListener(r, function () {
                  var e =
                    "string" == typeof n.value ? l.commands[n.value] : n.value;
                  if (!e)
                    throw new Error(
      ...
      t.d(n, "default", function () {
        ...
        t.d(n, "analyticsMiddleware", function () {
          return V;
        }),
        t.d(n, "onAnalyticsReady", function () {
          return X;
        }),
        t.d(n, "event", function () {
          return Y;
        }),
        t.d(n, "ecommerce", function () {
          return Z;
        }),
        t.d(n, "set", function () {
          return ee;
        ...
        t.d(n, "screenview", function () {
          return re;
        }),
        t.d(n, "time", function () {
          return oe;
        }),
        t.d(n, "require", function () {
          return ie;
        }),
        t.d(n, "exception", function () {
          return ce;
        }),
        t.d(n, "social", function () {
          return ae;
        });
      var V = function (e) {
          e.subscribe(function (e) {
            var n = e.payload;
            if (n && n.meta && n.meta.analytics) {
              var t = n.meta.analytics;
              if (!Array.isArray(t))
                throw new Error(
              ...
              t.forEach(function (e) {
                ...
                n ? (t = N[r])[n].apply(t, W(o)) : N[r].apply(N, W(o));
              });
            }
          });
        },
