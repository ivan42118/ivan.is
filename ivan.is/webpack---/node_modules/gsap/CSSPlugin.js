...
_gsScope._gsDefine(
  ...
  function () {
    ...
    var _numExp = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
      ...
      _createElement = function (type, ns) {
        var e = _doc.createElementNS
          ? _doc.createElementNS(ns || "http://www.w3.org/1999/xhtml", type)
      ...
      _supportsOpacity = (function () {
        ...
        _isSafariLT6 =
          _isSafari &&
          parseFloat(_agent.substr(_agent.indexOf("Version/") + 8, 2)) < 6;
      ...
      _getDimension = function (t, p, cs) {
        ...
        while (--i > -1) {
          ...
          v -=
            parseFloat(_getStyle(t, "border" + a[i] + "Width", cs, true)) || 0;
        }
        return v;
      },
      ...
      _parseVal = function (v, d) {
        ...
        if (typeof v === "string" && v.charAt(v.length - 2) === "v") {
          ...
          v =
            ...
            window["inner" + (v.substr(-2) === "vh" ? "Height" : "Width")] *
      ...
      _parseAngle = function (v, d, p, directionalEnd) {
        ...
        if (v == null) {
          ...
          dif =
            (isRelative
              ? parseInt(v.charAt(0) + "1", 10) * parseFloat(split[0].substr(2))
              : parseFloat(split[0])) *
    ...
    var _transformProps =
      ...
      _parseSVGOrigin = function (
        ...
        if (tm) {
          ...
          if (
            smoothOrigin ||
            (smoothOrigin !== false && CSSPlugin.defaultSmoothOrigin !== false)
          ) {
      ...
      _getTransform = (_internals.getTransform = function (t, cs, rec, parse) {
        ...
        if (m !== _identity2DMatrix) {
          if (m.length === 16) {
            ...
            //scales
            tm.scaleX =
              ((Math.sqrt(a11 * a11 + a21 * a21 + a31 * a31) * rnd + 0.5) | 0) /
              rnd;
            tm.scaleY =
              ((Math.sqrt(a22 * a22 + a32 * a32) * rnd + 0.5) | 0) / rnd;
            tm.scaleZ =
              ((Math.sqrt(a13 * a13 + a23 * a23 + a33 * a33) * rnd + 0.5) | 0) /
              rnd;
            a11 /= tm.scaleX;
            a12 /= tm.scaleY;
            a21 /= tm.scaleX;
    ...
    _registerComplexSpecialProp(
      "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
      {
        parser: function (t, e, parsingProp, cssp, pt, plugin, vars) {
          ...
          var scaleFunc =
            vars.scale && typeof vars.scale === "function" ? vars.scale : 0; //if there's a function-based "scale" value, swap in the resulting numeric value temporarily. Otherwise, if it's called for both scaleX and scaleY independently, they may not match (like if the function uses Math.random()).
          if (scaleFunc) {
        ...
        if (sp) {
          ...
          if (
            ...
            if ((bn || bn === 0) && (en || en === 0)) {
              ...
              pt.xs0 =
                es === "none" && (p === "display" || p.indexOf("Style") !== -1)
                  ? bs
    ...
    p.setRatio = function (v) {
      ...
      if (
        v === 1 &&
        (this._tween._time === this._tween._duration || this._tween._time === 0)
      ) {
        while (pt) {
          if (pt.type !== 2) {
            if (pt.r && pt.type !== -1) {
